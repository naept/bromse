<template>
    ...
    <div id="navbarBromse" class="navbar-menu" :class="showMenu ? 'is-active' : ''">
        <div class="navbar-end">
            <a target="_blank" rel="noopener noreferrer" class="navbar-item" href="https://naept.com/">Naept.com</a>
            <a target="_blank" rel="noopener noreferrer" class="navbar-item" href="https://blog.naept.com/">Blog</a>
            <a target="_blank" rel="noopener noreferrer" class="navbar-item" href="https://github.com/naept/bromse/">
